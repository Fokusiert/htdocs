...
return array (
  ...
  array (
    0 => 'as',
    1 => 'string',
    2 => 'Variable name for the result set',
    3 => true,
    4 => NULL,
    5 => true,
  ),
  ...
  array (
    ...
    2 => 'The parent node of the child nodes to show (instead of specifying the specific node set)',
    3 => false,
    4 => NULL,
    5 => true,
  ),
  ...
  array (
    0 => 'nodes',
    1 => 'array',
    2 => 'The specific collection of nodes to use for this paginator (instead of specifying the parentNode)',
    3 => false,
    4 => 
    array (
    ),
  ...
  array (
    0 => 'nodeTypeFilter',
    1 => 'string',
    2 => 'A node type (or more complex filter) to filter for in the results',
    3 => false,
    4 => NULL,
    5 => true,
  ),
...
# PathAndFilename: C:\Bitnami\neos-4.1.7-neu\apps\neos\htdocs\Packages\Application\Neos.ContentRepository\Classes\ViewHelpers\Widget\PaginateViewHelper.php
#