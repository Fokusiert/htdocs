...
return array (
  ...
  array (
    0 => 'ajax',
    1 => 'boolean',
    2 => 'true if the URI should be to an AJAX widget, false otherwise.',
    3 => false,
    4 => false,
    5 => true,
  ),
  ...
  array (
    0 => 'includeWidgetContext',
    1 => 'boolean',
    2 => 'true if the URI should contain the serialized widget context (only useful for stateless AJAX widgets)',
    3 => false,
    4 => false,
    5 => true,
  ),
...
# PathAndFilename: C:\Bitnami\neos-4.1.7-neu\apps\neos\htdocs\Packages\Framework\Neos.FluidAdaptor\Classes\ViewHelpers\Widget\LinkViewHelper.php
#