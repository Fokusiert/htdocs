 ...
 */
class DimensionsMenuImplementation_Original extends AbstractMenuImplementation
{
 ...
 * - presets (optional, array): If set, the presets are not loaded from the Settings, but instead taken from this property. Must be used with "dimension" set.
 */
class DimensionsMenuImplementation extends DimensionsMenuImplementation_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    public function __construct()
    {
        ...
        if ('Neos\Neos\Fusion\DimensionsMenuImplementation' === get_class($this)) {
...
# PathAndFilename: C:\Bitnami\neos-4.1.7-neu\apps\neos\htdocs\Packages\Application\Neos.Neos\Classes\Fusion\DimensionsMenuImplementation.php
#