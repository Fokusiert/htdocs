...
class Node extends Node_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    protected function emitBeforeNodeMove($movedNode, $referenceNode, $movePosition)
    {
        ...
        if (isset($this->Flow_Aop_Proxy_methodIsInAdviceMode['emitBeforeNodeMove'])) {
            $result = parent::emitBeforeNodeMove($movedNode, $referenceNode, $movePosition);
    ...
    protected function emitAfterNodeMove($movedNode, $referenceNode, $movePosition)
    {
        ...
        if (isset($this->Flow_Aop_Proxy_methodIsInAdviceMode['emitAfterNodeMove'])) {
            $result = parent::emitAfterNodeMove($movedNode, $referenceNode, $movePosition);
     ...
     * @\Neos\Flow\Annotations\Signal
     */
    protected function emitBeforeNodeCopy(\Neos\ContentRepository\Domain\Model\NodeInterface $sourceNode, \Neos\ContentRepository\Domain\Model\NodeInterface $targetParentNode)
    {

        if (isset($this->Flow_Aop_Proxy_methodIsInAdviceMode['emitBeforeNodeCopy'])) {
            $result = parent::emitBeforeNodeCopy($sourceNode, $targetParentNode);
     ...
     * @\Neos\Flow\Annotations\Signal
     */
    protected function emitAfterNodeCopy(\Neos\ContentRepository\Domain\Model\NodeInterface $copiedNode, \Neos\ContentRepository\Domain\Model\NodeInterface $targetParentNode)
    {

        if (isset($this->Flow_Aop_Proxy_methodIsInAdviceMode['emitAfterNodeCopy'])) {
            $result = parent::emitAfterNodeCopy($copiedNode, $targetParentNode);
...
# PathAndFilename: C:\Bitnami\neos-4.1.7-neu\apps\neos\htdocs\Packages\Application\Neos.ContentRepository\Classes\Domain\Model\Node.php
#