...
return array (
  ...
  array (
    0 => 'node',
    1 => 'mixed',
    2 => 'A node object, a string node path (absolute or relative), a string node://-uri or NULL',
    3 => false,
    4 => NULL,
    5 => true,
  ),
  ...
  array (
    0 => 'format',
    1 => 'string',
    2 => 'Format to use for the URL, for example "html" or "json',
    3 => false,
    4 => NULL,
    5 => true,
  ),
  ...
  array (
    0 => 'absolute',
    1 => 'boolean',
    2 => 'If set, an absolute URI is rendered',
    3 => false,
    4 => false,
    5 => true,
  ),
  ...
  array (
    0 => 'arguments',
    1 => 'array',
    2 => 'Additional arguments to be passed to the UriBuilder (for example pagination parameters)',
    3 => false,
    4 => 
    array (
    ),
  ...
  array (
    0 => 'baseNodeName',
    1 => 'string',
    2 => 'The variable the node will be assigned to for the rendered child content',
    3 => false,
    4 => 'documentNode',
    5 => true,
  ),
  ...
  array (
    0 => 'nodeVariableName',
    1 => 'string',
    2 => 'The name of the base node inside the Fusion context to use for the ContentContext or resolving relative paths',
    3 => false,
    4 => 'linkedNode',
    5 => true,
  ),
  ...
  array (
    0 => 'resolveShortcuts',
    1 => 'boolean',
    2 => 'INTERNAL Parameter - if false, shortcuts are not redirected to their target. Only needed on rare backend occasions when we want to link to the shortcut itself.',
    3 => false,
    4 => true,
    5 => true,
  ),
...
# PathAndFilename: C:\Bitnami\neos-4.1.7-neu\apps\neos\htdocs\Packages\Application\Neos.Neos\Classes\ViewHelpers\Link\NodeViewHelper.php
#