...
return array (
  ...
  array (
    0 => 'path',
    1 => 'string',
    2 => 'Relative Fusion path to be rendered',
    3 => true,
    4 => NULL,
    5 => true,
  ),
  ...
  array (
    0 => 'context',
    1 => 'array',
    2 => 'Additional context variables to be set.',
    3 => false,
    4 => NULL,
    5 => true,
  ),
  ...
  array (
    0 => 'fusionPackageKey',
    1 => 'string',
    2 => 'The key of the package to load Fusion from, if not from the current context.',
    3 => false,
    4 => NULL,
    5 => true,
  ),
...
# PathAndFilename: C:\Bitnami\neos-4.1.7-neu\apps\neos\htdocs\Packages\Application\Neos.Fusion\Classes\ViewHelpers\RenderViewHelper.php
#