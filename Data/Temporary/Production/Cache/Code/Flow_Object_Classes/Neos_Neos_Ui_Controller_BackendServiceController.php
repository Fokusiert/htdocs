...
class BackendServiceController extends BackendServiceController_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    protected function Flow_Aop_Proxy_buildMethodsAndAdvicesArray()
    {
        ...
        $this->Flow_Aop_Proxy_targetMethodsAndGroupedAdvices = array(
            ...
            'initializeGetPolicyInformationAction' => array(
                'Neos\Flow\Aop\Advice\AroundAdvice' => array(
                    new \Neos\Flow\Aop\Advice\AroundAdvice('Neos\Flow\Security\Aspect\PolicyEnforcementAspect', 'enforcePolicy', $objectManager, NULL),
                ),
            ),
            'getPolicyInformationAction' => array(
                'Neos\Flow\Aop\Advice\AroundAdvice' => array(
                    new \Neos\Flow\Aop\Advice\AroundAdvice('Neos\Flow\Security\Aspect\PolicyEnforcementAspect', 'enforcePolicy', $objectManager, NULL),
                ),
            ),
    ...
    public function initializeGetPolicyInformationAction()
    {
        ...
        if (isset($this->Flow_Aop_Proxy_methodIsInAdviceMode['initializeGetPolicyInformationAction'])) {
            $result = parent::initializeGetPolicyInformationAction();

        } else {
            $this->Flow_Aop_Proxy_methodIsInAdviceMode['initializeGetPolicyInformationAction'] = true;
            try {
            
                $methodArguments = [];

                $adviceChains = $this->Flow_Aop_Proxy_getAdviceChains('initializeGetPolicyInformationAction');
                $adviceChain = $adviceChains['Neos\Flow\Aop\Advice\AroundAdvice'];
                $adviceChain->rewind();
                $joinPoint = new \Neos\Flow\Aop\JoinPoint($this, 'Neos\Neos\Ui\Controller\BackendServiceController', 'initializeGetPolicyInformationAction', $methodArguments, $adviceChain);
                $result = $adviceChain->proceed($joinPoint);
                $methodArguments = $joinPoint->getMethodArguments();

            } catch (\Exception $exception) {
                unset($this->Flow_Aop_Proxy_methodIsInAdviceMode['initializeGetPolicyInformationAction']);
                throw $exception;
            }
            unset($this->Flow_Aop_Proxy_methodIsInAdviceMode['initializeGetPolicyInformationAction']);
        }
    ...
    public function getPolicyInformationAction(array $nodes)
    {
        ...
        if (isset($this->Flow_Aop_Proxy_methodIsInAdviceMode['getPolicyInformationAction'])) {
            $result = parent::getPolicyInformationAction($nodes);

        } else {
            $this->Flow_Aop_Proxy_methodIsInAdviceMode['getPolicyInformationAction'] = true;
            try {
                ...
                $adviceChains = $this->Flow_Aop_Proxy_getAdviceChains('getPolicyInformationAction');
                $adviceChain = $adviceChains['Neos\Flow\Aop\Advice\AroundAdvice'];
                $adviceChain->rewind();
                $joinPoint = new \Neos\Flow\Aop\JoinPoint($this, 'Neos\Neos\Ui\Controller\BackendServiceController', 'getPolicyInformationAction', $methodArguments, $adviceChain);
                $result = $adviceChain->proceed($joinPoint);
                $methodArguments = $joinPoint->getMethodArguments();

            } catch (\Exception $exception) {
                unset($this->Flow_Aop_Proxy_methodIsInAdviceMode['getPolicyInformationAction']);
                throw $exception;
            }
            unset($this->Flow_Aop_Proxy_methodIsInAdviceMode['getPolicyInformationAction']);
        }
...
return array (
  ...
  array (
    ...
    array (
      'position' => 0,
      'optional' => false,
      'type' => 'Neos\\Neos\\Ui\\Domain\\Model\\ChangeCollection',
      'class' => 'Neos\\Neos\\Ui\\Domain\\Model\\ChangeCollection',
      'array' => false,
      'byReference' => false,
      'allowsNull' => false,
      'defaultValue' => NULL,
  ...
  array (
    ...
    array (
      'position' => 0,
      'optional' => false,
      'type' => 'Neos\\Neos\\Ui\\Domain\\Service\\NodeTreeBuilder',
      'class' => 'Neos\\Neos\\Ui\\Domain\\Service\\NodeTreeBuilder',
      'array' => false,
      'byReference' => false,
      'allowsNull' => false,
      'defaultValue' => NULL,
  ...
  'initializeGetPolicyInformationAction' => 
  array (
  ),
  'getPolicyInformationAction' => 
  array (
    'nodes' => 
    array (
      'position' => 0,
      'optional' => false,
      'type' => 'array<Neos\\ContentRepository\\Domain\\Model\\NodeInterface>',
      'class' => NULL,
      'array' => true,
      'byReference' => false,
      'allowsNull' => false,
...
return array (
  ...
  'publishAction' => true,
  'discardAction' => true,
  'changeBaseWorkspaceAction' => true,
  'getWorkspaceInfoAction' => true,
  'initializeLoadTreeAction' => true,
  'loadTreeAction' => true,
  'initializeGetPolicyInformationAction' => true,
  'getPolicyInformationAction' => true,
  'flowQueryAction' => true,
);
    }
}
# PathAndFilename: C:\Bitnami\neos-4.1.7-neu\apps\neos\htdocs\Packages\Application\Neos.Neos.Ui\Classes\Controller\BackendServiceController.php
#