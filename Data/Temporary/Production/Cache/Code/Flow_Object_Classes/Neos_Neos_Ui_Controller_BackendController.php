...
class BackendController extends BackendController_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
     ...
     * @return void
     */
    public function deactivateAction(\Neos\ContentRepository\Domain\Model\NodeInterface $node = NULL)
    {

        if (isset($this->Flow_Aop_Proxy_methodIsInAdviceMode['deactivateAction'])) {
            $result = parent::deactivateAction($node);
            ...
            try {
                ...
                $adviceChain = $adviceChains['Neos\Flow\Aop\Advice\AroundAdvice'];
                $adviceChain->rewind();
                $joinPoint = new \Neos\Flow\Aop\JoinPoint($this, 'Neos\Neos\Ui\Controller\BackendController', 'deactivateAction', $methodArguments, $adviceChain);
                $result = $adviceChain->proceed($joinPoint);
                $methodArguments = $joinPoint->getMethodArguments();
...
return array (
  ...
  array (
    ...
    array (
      'position' => 0,
      'optional' => true,
      'type' => 'Neos\\ContentRepository\\Domain\\Model\\NodeInterface|null',
      'class' => 'Neos\\ContentRepository\\Domain\\Model\\NodeInterface',
      'array' => false,
      'byReference' => false,
      'allowsNull' => true,
...
# PathAndFilename: C:\Bitnami\neos-4.1.7-neu\apps\neos\htdocs\Packages\Application\Neos.Neos.Ui\Classes\Controller\BackendController.php
#