 ...
 * @Flow\Aspect
 */
class XliffConfigurationCacheHeaderAspect_Original
{
 ...
 */
class XliffConfigurationCacheHeaderAspect extends XliffConfigurationCacheHeaderAspect_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    {
        if (get_class($this) === 'Neos\Neos\Ui\Aspects\XliffConfigurationCacheHeaderAspect') \Neos\Flow\Core\Bootstrap::$staticObjectManager->setInstance('Neos\Neos\Ui\Aspects\XliffConfigurationCacheHeaderAspect', $this);
        if ('Neos\Neos\Ui\Aspects\XliffConfigurationCacheHeaderAspect' === get_class($this)) {
...
# PathAndFilename: C:\Bitnami\neos-4.1.7-neu\apps\neos\htdocs\Packages\Application\Neos.Neos.Ui\Classes\Aspects\XliffConfigurationCacheHeaderAspect.php
#