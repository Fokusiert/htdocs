<?php 
class Frontend_Node_action_show_2652c63431f067cd2e92c43a0d8d39b7f445d0c2 extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$output4 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('item.state', $array5)]);
...
$array9 = array (
);return call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('item.label', $array9)]);
};
$arguments6 = array();
$arguments6['additionalAttributes'] = NULL;
$arguments6['data'] = NULL;
$arguments6['node'] = NULL;
...
$arguments6['baseNodeName'] = 'documentNode';
$arguments6['nodeVariableName'] = 'linkedNode';
$arguments6['resolveShortcuts'] = true;
...
$array8 = array (
);$arguments6['node'] = $renderingContext->getVariableProvider()->getByPath('item.node', $array8);

$output4 .= Neos\Neos\ViewHelpers\Link\NodeViewHelper::renderStatic($arguments6, $renderChildrenClosure7, $renderingContext);
...
$arguments1['as'] = 'item';
$arguments1['iteration'] = 'menuItemIterator';
...
$arguments11['section'] = 'itemList';
// Rendering Array
$array13 = array();
$array14 = array (
);$array13['items'] = $renderingContext->getVariableProvider()->getByPath('items', $array14);
...
$output21 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('item.state', $array22)]);
...
$array26 = array (
);return call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('item.label', $array26)]);
};
$arguments23 = array();
$arguments23['additionalAttributes'] = NULL;
$arguments23['data'] = NULL;
$arguments23['node'] = NULL;
...
$arguments23['baseNodeName'] = 'documentNode';
$arguments23['nodeVariableName'] = 'linkedNode';
$arguments23['resolveShortcuts'] = true;
...
$array25 = array (
);$arguments23['node'] = $renderingContext->getVariableProvider()->getByPath('item.node', $array25);

$output21 .= Neos\Neos\ViewHelpers\Link\NodeViewHelper::renderStatic($arguments23, $renderChildrenClosure24, $renderingContext);
...
$array20 = array (
);$arguments18['each'] = $renderingContext->getVariableProvider()->getByPath('items', $array20);
$arguments18['as'] = 'item';
$arguments18['iteration'] = 'menuItemIterator';
