<?php 
class Frontend_Node_action_show_30fed47cfe5b004e08d605e217ac84868fdbfaa3 extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$output21 .= '
			';
// Rendering ViewHelper Neos\Form\ViewHelpers\RenderViewHelper
$renderChildrenClosure23 = function() use ($renderingContext, $self) {
return NULL;
};
$arguments22 = array();
$arguments22['persistenceIdentifier'] = NULL;
$arguments22['factoryClass'] = 'Neos\\Form\\Factory\\ArrayFormFactory';
$arguments22['presetName'] = 'default';
$arguments22['overrideConfiguration'] = array (
);
$array24 = array (
);$arguments22['persistenceIdentifier'] = $renderingContext->getVariableProvider()->getByPath('formIdentifier', $array24);
$array25 = array (
);$arguments22['presetName'] = $renderingContext->getVariableProvider()->getByPath('presetName', $array25);
$array26 = array (
);$arguments22['overrideConfiguration'] = $renderingContext->getVariableProvider()->getByPath('overrideConfiguration', $array26);

$output21 .= Neos\Form\ViewHelpers\RenderViewHelper::renderStatic($arguments22, $renderChildrenClosure23, $renderingContext);
...
$arguments30['source'] = 'Main';
$arguments30['package'] = NULL;
$arguments30['quantity'] = NULL;
$arguments30['locale'] = NULL;
$arguments30['id'] = 'content.noValidFormIdentifier';
$arguments30['package'] = 'Neos.NodeTypes.Form';
$arguments30['source'] = 'NodeTypes/Form';

$output29 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [Neos\FluidAdaptor\ViewHelpers\TranslateViewHelper::renderStatic($arguments30, $renderChildrenClosure31, $renderingContext)]);
...
$array15 = array();
$array16 = array (
);$array15['0'] = $renderingContext->getVariableProvider()->getByPath('formIdentifier', $array16);
...
$arguments7['factoryClass'] = 'Neos\\Form\\Factory\\ArrayFormFactory';
$arguments7['presetName'] = 'default';
$arguments7['overrideConfiguration'] = array (
);
$array9 = array (
);$arguments7['persistenceIdentifier'] = $renderingContext->getVariableProvider()->getByPath('formIdentifier', $array9);
$array10 = array (
);$arguments7['presetName'] = $renderingContext->getVariableProvider()->getByPath('presetName', $array10);
$array11 = array (
);$arguments7['overrideConfiguration'] = $renderingContext->getVariableProvider()->getByPath('overrideConfiguration', $array11);

$output6 .= Neos\Form\ViewHelpers\RenderViewHelper::renderStatic($arguments7, $renderChildrenClosure8, $renderingContext);
...
$arguments13['source'] = 'Main';
$arguments13['package'] = NULL;
$arguments13['quantity'] = NULL;
$arguments13['locale'] = NULL;
$arguments13['id'] = 'content.noValidFormIdentifier';
$arguments13['package'] = 'Neos.NodeTypes.Form';
$arguments13['source'] = 'NodeTypes/Form';

$output12 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [Neos\FluidAdaptor\ViewHelpers\TranslateViewHelper::renderStatic($arguments13, $renderChildrenClosure14, $renderingContext)]);
