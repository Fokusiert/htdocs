<?php 
class Frontend_Node_action_show_d31fb64256a0ced9a2b21dab0b2030b5d78f02d6 extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$array9 = array (
);return $renderingContext->getVariableProvider()->getByPath('attributes', $array9);
};
$arguments7 = array();
...
$arguments18 = array();
$arguments18['path'] = NULL;
$arguments18['context'] = NULL;
$arguments18['fusionPackageKey'] = NULL;
$arguments18['fusionFilePathPattern'] = NULL;
$output20 = '';
$array21 = array (
);
$output20 .= $renderingContext->getVariableProvider()->getByPath('item.state', $array21);

$output20 .= '.attributes';
$arguments18['path'] = $output20;
// Rendering Array
$array22 = array();
$array23 = array (
);$array22['item'] = $renderingContext->getVariableProvider()->getByPath('item', $array23);
$arguments18['context'] = $array22;
return Neos\Fusion\ViewHelpers\RenderViewHelper::renderStatic($arguments18, $renderChildrenClosure19, $renderingContext);
};
$arguments16 = array();
...
$output38 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('item.label', $array39)]);
...
$arguments43['baseNodeName'] = 'documentNode';
$arguments43['nodeVariableName'] = 'linkedNode';
$arguments43['resolveShortcuts'] = true;
...
$array45 = array (
);$arguments43['node'] = $renderingContext->getVariableProvider()->getByPath('item.node', $array45);

$output42 .= Neos\Neos\ViewHelpers\Link\NodeViewHelper::renderStatic($arguments43, $renderChildrenClosure44, $renderingContext);
...
$array32 = array();
$array33 = array (
);$array32['0'] = $renderingContext->getVariableProvider()->getByPath('item.state', $array33);
$array32['1'] = ' === \'current\'';

$expression34 = function($context) {return (TYPO3Fluid\Fluid\Core\Parser\BooleanParser::convertNodeToBoolean($context["node0"]) === 'current');};
...
$output26 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('item.label', $array27)]);
...
$arguments29['baseNodeName'] = 'documentNode';
$arguments29['nodeVariableName'] = 'linkedNode';
$arguments29['resolveShortcuts'] = true;
...
$array31 = array (
);$arguments29['node'] = $renderingContext->getVariableProvider()->getByPath('item.node', $array31);

$output28 .= Neos\Neos\ViewHelpers\Link\NodeViewHelper::renderStatic($arguments29, $renderChildrenClosure30, $renderingContext);
...
$output15 .= TYPO3Fluid\Fluid\ViewHelpers\IfViewHelper::renderStatic($arguments24, $renderChildrenClosure25, $renderingContext);
...
$array12 = array (
);$arguments10['each'] = $renderingContext->getVariableProvider()->getByPath('items', $array12);
$arguments10['as'] = 'item';
// Rendering Boolean node
// Rendering Array
$array13 = array();
...
$arguments10['reverse'] = TYPO3Fluid\Fluid\Core\Parser\SyntaxTree\BooleanNode::convertToBoolean(
					$expression14(
