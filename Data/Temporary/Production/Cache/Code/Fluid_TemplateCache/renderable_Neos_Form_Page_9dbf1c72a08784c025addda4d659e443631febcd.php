<?php 
class renderable_Neos_Form_Page_9dbf1c72a08784c025addda4d659e443631febcd extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$output9 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('page.identifier', $array10)]);

$output9 .= '.label';
$arguments7['id'] = $output9;
$array11 = array (
);$arguments7['package'] = call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('page.renderingOptions.translationPackage', $array11)]);
$array12 = array (
