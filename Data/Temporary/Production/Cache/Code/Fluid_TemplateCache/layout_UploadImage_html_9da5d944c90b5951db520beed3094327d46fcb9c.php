<?php 
class layout_UploadImage_html_9da5d944c90b5951db520beed3094327d46fcb9c extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$array9 = array (
);$arguments7['path'] = $renderingContext->getVariableProvider()->getByPath('style', $array9);
...
$array5 = array (
);$arguments3['each'] = $renderingContext->getVariableProvider()->getByPath('settings.styles', $array5);
$arguments3['as'] = 'style';
...
$output0 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('settings.bodyClasses', $array10)]);

$output0 .= ' media-browser-inspector">
...
$arguments11['partial'] = 'FlashMessages';
...
$array21 = array (
);$arguments19['path'] = $renderingContext->getVariableProvider()->getByPath('script', $array21);

$output18 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [Neos\FluidAdaptor\ViewHelpers\Uri\ResourceViewHelper::renderStatic($arguments19, $renderChildrenClosure20, $renderingContext)]);
...
$array17 = array (
);$arguments15['each'] = $renderingContext->getVariableProvider()->getByPath('settings.scripts', $array17);
$arguments15['as'] = 'script';
...
$output0 .= TYPO3Fluid\Fluid\ViewHelpers\RenderViewHelper::renderStatic($arguments22, $renderChildrenClosure23, $renderingContext);
